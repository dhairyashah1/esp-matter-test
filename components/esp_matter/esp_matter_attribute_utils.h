...
/** Attribute report
 *
 * This API report the attribute value.
 * After this API is called, the application don't gets the attribute update callback with `PRE_UPDATE` or `POST_UPDATE`, the
