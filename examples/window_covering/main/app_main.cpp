...
extern "C" void app_main()
{
    ...
    /* Initialize driver */ 
    // handlers definition in app_driver.cpp
    ...
    /// WINDOW_COVERING ////////////////////////////////////////////////////////////////////////////////////////////////////
    window_covering_device::config_t window_covering_config;
    window_covering_config.window_covering.type = 0x08; // Tilt blind - tilt and lift
    
    endpoint_t *endpoint = window_covering_device::create(node, &window_covering_config, ENDPOINT_FLAG_NONE, NULL);
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // app_driver_light_set_defaults(window_covering_endpoint_id);
